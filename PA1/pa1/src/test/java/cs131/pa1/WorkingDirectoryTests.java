...
public class WorkingDirectoryTests {
	...
	@Test
	public void testBasicPwd() throws IOException{
		testInput("pwd\nexit");
	...
	@Test
	public void testPwdWithChangedDirectory() throws IOException{
		testInput("pwd\ncd src\npwd\nexit");
		SequentialREPL.main(null);
		String expectation = Message.NEWCOMMAND + "" + System.getProperty("user.dir");
	...
	@Test
	public void testPwdWithCdDot() throws IOException{
		testInput("pwd\ncd .\npwd\nexit");
		SequentialREPL.main(null);
		String expectation = Message.NEWCOMMAND + "" + System.getProperty("user.dir");
		expectation += "\n> " + expectation + "\n";
	...
	@Test
	public void testPwdWithCdDotDot() throws IOException{
		testInput("pwd\ncd ..\npwd\nexit");
		SequentialREPL.main(null);
		String expectation = Message.NEWCOMMAND + "" + System.getProperty("user.dir");
	...
	@Test
	public void testMultiMoveDirectory() throws IOException{
